            ...
            <tr>
                ...
                <td style="width: 503px; height: 248px">
                    <div style="width: 498px; height: 218px">
                        <asp:Label ID="Label1" runat="server" Text="Enter Your e-Mail Id To Get  Access key"
                            Width="458px"></asp:Label><br />
                        <br />
                        <table style="width: 493px; height: 133px">
                            <tr>
                                <td dir="rtl" style="width: 165px">
                                    <asp:Label ID="Label2" runat="server" Text="e-Mail Id" Width="88px"></asp:Label></td>
                                <td colspan="2">
                                    <asp:TextBox ID="TextBox1" runat="server" BackColor="Info" Width="221px" ToolTip="Enter mail id"></asp:TextBox></td>
                            </tr>
                            <tr>
                                <td style="width: 165px">
                                </td>
                                <td colspan="2">
                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="Please enter valid e-Mail Id" ControlToValidate="Textbox1" ValidationExpression="\w+([-+.]\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"
                            ...
                            <tr>
                                ...
                                <td style="width: 228px">
                                    <asp:Button ID="Button1" runat="server" Height="27px" Text="submit" Width="123px" OnClick="Button1_Click" ToolTip="Click to get access key" /></td>
                                <td>
                                </td>
                            </tr>
                        </table>
                        <asp:Label ID="Label3" runat="server" Font-Bold="True" ForeColor="Maroon" Height="34px"
                            Text="Access key has been send to your e-Mail Id" Visible="False" Width="476px"></asp:Label></div>
                </td>
